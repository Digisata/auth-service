...
type AuthServiceClient interface {
	...
	GetUserByID(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GetUserByIDResponse, error)
}
...
func (c *authServiceClient) GetUserByID(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GetUserByIDResponse, error) {
...
type AuthServiceServer interface {
	...
	GetUserByID(context.Context, *empty.Empty) (*GetUserByIDResponse, error)
...
func (UnimplementedAuthServiceServer) GetUserByID(context.Context, *empty.Empty) (*GetUserByIDResponse, error) {
...
func _AuthService_GetUserByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetUserByID(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
